package com.clickbus.places_api.security.filters;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        //     throw new JwtException("Authorization token required");
        // }
        ...
        if (requestTokenHeader != null && requestTokenHeader.startsWith(JWT_PREFIX)) {
            ...
            jwtToken = requestTokenHeader.substring(JWT_PREFIX.length());
